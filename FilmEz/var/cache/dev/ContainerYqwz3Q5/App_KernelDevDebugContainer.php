...
class App_KernelDevDebugContainer extends Container
{
    ...
    protected static function getHttpKernelService($container)
    {
        ...
        $a->allowControllers(['App\\Kernel', 'App\\Controller\\AuthController', 'App\\Controller\\CategorieController', 'App\\Controller\\CommentController', 'App\\Controller\\FilmController', 'App\\Controller\\LikeController', 'Doctrine\\Bundle\\DoctrineBundle\\Controller\\ProfilerController']);
    ...
    protected static function getDebug_Security_FirewallService($container)
    {
        ...
        return $container->privates['debug.security.firewall'] = new \Symfony\Bundle\SecurityBundle\Debug\TraceableFirewallListener(new \Symfony\Bundle\SecurityBundle\Security\FirewallMap($a, new RewindableGenerator(function () use ($container) {
            ...
            yield 'security.firewall.map.context.login' => ($container->privates['.security.request_matcher.z6bjeEc'] ?? $container->load('get_Security_RequestMatcher_Z6bjeEcService'));
            yield 'security.firewall.map.context.api' => ($container->privates['.security.request_matcher.mh_h4R8'] ?? $container->load('get_Security_RequestMatcher_MhH4R8Service'));
